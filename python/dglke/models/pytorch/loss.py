#
# This file is modified, add function MyLoss
#
...
class MyLoss(BaseMyLoss):
    def __init__(self, margin):
        super(MyLoss, self).__init__(margin)
...
class LossGenerator(BaseLossGenerator):
    def __init__(self, args, loss_genre='Logsigmoid', neg_adversarial_sampling=False, adversarial_temperature=1.0,
        ...
        elif loss_genre == 'Myloss':
            self.neg_label = -1
            self.loss_criterion = MyLoss(args.margin)
        else:
