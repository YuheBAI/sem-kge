...
# train.py
#
# This file is modified, add self.add_argument('--sem_part', action='store_true',
#
...
# extra arguments used for train, e.g. partitioning
class ArgParser(CommonArgParser):
    def __init__(self):
        ...
        self.add_argument('--sem_part', action='store_true',
                          help='Enable semantic partitioning for multi-GPU training.')
...
def main():
    args = ArgParser().parse_args() # function of library argparse
    ...
    g = ConstructGraph(dataset, args) # type dgl.heterograph.DGLHeteroGraph
    print(g)
    print(type(g))
    ...
    if args.num_proc > 1:
        ...
        for i in range(args.num_proc):
            ...
            train_sampler_head = train_data.create_sampler(args.batch_size, # CHANGE!!
